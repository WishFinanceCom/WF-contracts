...
const errorsLibrary = {
    ...
    WF_PLATFORM_PROXY_ALREADY_EXISTS: errorScope.bmcplatform + 0,
    WF_PLATFORM_CANNOT_APPLY_TO_ONESELF: errorScope.bmcplatform + 1,
    WF_PLATFORM_INVALID_VALUE: errorScope.bmcplatform + 2,
    WF_PLATFORM_INSUFFICIENT_BALANCE: errorScope.bmcplatform + 3,
    WF_PLATFORM_NOT_ENOUGH_ALLOWANCE: errorScope.bmcplatform + 4,
    WF_PLATFORM_ASSET_ALREADY_ISSUED: errorScope.bmcplatform + 5,
    WF_PLATFORM_CANNOT_ISSUE_FIXED_ASSET_WITH_INVALID_VALUE: errorScope.bmcplatform + 6,
    WF_PLATFORM_CANNOT_REISSUE_FIXED_ASSET: errorScope.bmcplatform + 7,
    WF_PLATFORM_SUPPLY_OVERFLOW: errorScope.bmcplatform + 8,
    WF_PLATFORM_NOT_ENOUGH_TOKENS: errorScope.bmcplatform + 9,
    WF_PLATFORM_INVALID_NEW_OWNER: errorScope.bmcplatform + 10,
    WF_PLATFORM_ALREADY_TRUSTED: errorScope.bmcplatform + 11,
    WF_PLATFORM_SHOULD_RECOVER_TO_NEW_ADDRESS: errorScope.bmcplatform + 12,
    WF_PLATFORM_ASSET_IS_NOT_ISSUED: errorScope.bmcplatform + 13,
    WF_PLATFORM_ACCESS_DENIED_ONLY_OWNER: errorScope.bmcplatform + 14,
    WF_PLATFORM_ACCESS_DENIED_ONLY_PROXY: errorScope.bmcplatform + 15,
    WF_PLATFORM_ACCESS_DENIED_ONLY_TRUSTED: errorScope.bmcplatform + 16,
    WF_PLATFORM_INVALID_INVOCATION: errorScope.bmcplatform + 17
}
